...
class rgb2xyz {
    constructor() {
        this.x = 0.430574 * this.r + 0.34155 * this.g + 0.178325 * this.b;
        this.y = 0.222015 * this.r + 0.706655 * this.g + 0.07133 * this.b;
        this.z = 0.020183 * this.r + 0.129553 * this.g + 0.93918 * this.b;
